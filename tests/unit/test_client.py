...
class TestErrorHandlingPlatformMode:
    ...
    @pytest.mark.asyncio
    async def test_maps_401_to_authentication_error(self, client: OtariClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_maps_403_to_authentication_error(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_maps_404_to_model_not_found(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_maps_402_to_insufficient_funds(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_maps_429_to_rate_limit_with_retry_after(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_maps_502_to_upstream_provider_error(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_maps_504_to_gateway_timeout(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_includes_correlation_id_in_message(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_passes_through_unrecognized_status(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_passes_through_non_api_error(self, client: OtariClient) -> None:
        client.openai.chat.completions.create = AsyncMock(  # type: ignore[method-assign]
    ...
    @pytest.mark.asyncio
    async def test_stores_original_error(self, client: OtariClient) -> None:
...
class TestMethodDelegation:
    ...
    @pytest.mark.asyncio
    async def test_completion_delegates(self, client: OtariClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_embedding_delegates(self, client: OtariClient) -> None:
        mock_response = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_response_delegates(self, client: OtariClient) -> None:
        mock_response = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_list_models_delegates(self, client: OtariClient) -> None:
        mock_models = [
    ...
    @pytest.mark.asyncio
    async def test_error_mapping_on_embedding(self, client: OtariClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_error_mapping_on_response(self, client: OtariClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_error_mapping_on_list_models(self, client: OtariClient) -> None:
...
class TestBatchOperations:
    ...
    @pytest.mark.asyncio
    async def test_create_batch(self, client: OtariClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_retrieve_batch(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            200,
    ...
    @pytest.mark.asyncio
    async def test_cancel_batch(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            200,
    ...
    @pytest.mark.asyncio
    async def test_list_batches(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            200,
    ...
    @pytest.mark.asyncio
    async def test_retrieve_batch_results(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            200,
            json={
                "results": [
...
class TestBatchErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_409_maps_to_batch_not_complete(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            409,
    ...
    @pytest.mark.asyncio
    async def test_404_suggests_upgrade(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            404,
    ...
    @pytest.mark.asyncio
    async def test_404_passes_through_not_found(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            404,
    ...
    @pytest.mark.asyncio
    async def test_401_maps_to_authentication_error(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            401,
    ...
    @pytest.mark.asyncio
    async def test_429_maps_to_rate_limit(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            429,
    ...
    @pytest.mark.asyncio
    async def test_502_maps_to_upstream_error(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            502,
    ...
    @pytest.mark.asyncio
    async def test_504_maps_to_gateway_timeout(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            504,
    ...
    @pytest.mark.asyncio
    async def test_correlation_id_in_batch_error(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            401,
    ...
    @pytest.mark.asyncio
    async def test_unknown_status_maps_to_otari_error(self, client: OtariClient) -> None:
        mock_response = httpx.Response(
            418,
