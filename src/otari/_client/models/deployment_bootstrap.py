...
class DeploymentBootstrap(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data_plane_url", "deployment_type", "docs_url", "mail_ready", "maintenance_mode", "management_url", "oauth_providers", "open_signup", "passkeys_ready", "privacy_url", "public_catalog", "session_type", "sign_in_methods", "surfaces", "terms_url"]
