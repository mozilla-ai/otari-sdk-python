...
class WorkspaceMembersPublic(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceMembersPublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceMembersPublic from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "data": [WorkspaceMemberPublic.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
