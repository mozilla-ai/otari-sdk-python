...
class GateResultResponse(BaseModel):
    ...
    message: StrictStr
    outcome: StrictStr
    __properties: ClassVar[List[str]] = ["detail", "enforcement", "gate_id", "message", "outcome"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GateResultResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GateResultResponse from a dict"""
        if obj is None:
            return None
