...
class CCKChunkChoice(BaseModel):
    """
    CCKChunkChoice
    """ # noqa: E501
    ...
    index: StrictInt
    logprobs: Optional[CCKChoiceLogprobs] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CCKChunkChoice from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CCKChunkChoice from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "delta": CCKChoiceDelta.from_dict(obj["delta"]) if obj.get("delta") is not None else None,
            "finish_reason": obj.get("finish_reason"),
            "index": obj.get("index"),
            "logprobs": CCKChoiceLogprobs.from_dict(obj["logprobs"]) if obj.get("logprobs") is not None else None
        })
