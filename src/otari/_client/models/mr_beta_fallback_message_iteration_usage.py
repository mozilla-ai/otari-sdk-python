...
class MRBetaFallbackMessageIterationUsage(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['fallback_message']):
            raise ValueError("must be one of enum values ('fallback_message')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MRBetaFallbackMessageIterationUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MRBetaFallbackMessageIterationUsage from a dict"""
        if obj is None:
            return None
