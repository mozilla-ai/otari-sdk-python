...
class UsageGroupedSeriesPoint(BaseModel):
    ...
    requests: StrictInt
    tokens: StrictInt
    __properties: ClassVar[List[str]] = ["bucket_start", "cost", "is_other", "key", "requests", "tokens"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsageGroupedSeriesPoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsageGroupedSeriesPoint from a dict"""
        if obj is None:
            return None
