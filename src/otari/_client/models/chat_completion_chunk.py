...
class ChatCompletionChunk(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "choices": [CCKChunkChoice.from_dict(_item) for _item in obj["choices"]] if obj.get("choices") is not None else None,
            "created": obj.get("created"),
            "model": obj.get("model"),
            "object": obj.get("object"),
            "service_tier": obj.get("service_tier"),
            "system_fingerprint": obj.get("system_fingerprint"),
            "usage": CCKCompletionUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
