...
class PricingRefreshChangeResponse(BaseModel):
    ...
    change: StrictStr
    model_key: StrictStr
    __properties: ClassVar[List[str]] = ["change", "model_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PricingRefreshChangeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PricingRefreshChangeResponse from a dict"""
        if obj is None:
            return None
