...
class UpdateOwnKeyRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowed_models", "capture_agent_telemetry", "expires_at", "is_active", "key_name", "metadata", "reject_user_mismatch"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateOwnKeyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateOwnKeyRequest from a dict"""
        if obj is None:
            return None
