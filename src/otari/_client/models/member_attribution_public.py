...
class MemberAttributionPublic(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["allowed_models", "blocked", "reserved", "spend"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberAttributionPublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberAttributionPublic from a dict"""
        if obj is None:
            return None
