...
CALLER1_ANY_OF_SCHEMAS = ["MRDirectCaller", "MRServerToolCaller", "MRServerToolCaller20260120"]

class Caller1(BaseModel):
    """
    Caller1
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = Caller1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Caller1 with anyOf schemas: MRDirectCaller, MRServerToolCaller, MRServerToolCaller20260120. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Caller1 with anyOf schemas: MRDirectCaller, MRServerToolCaller, MRServerToolCaller20260120. Details: " + ", ".join(error_messages))
        else:
            return instance
