...
class AgentTelemetryGroupRow(BaseModel):
    ...
    rows: StrictInt
    __properties: ClassVar[List[str]] = ["is_other", "key", "rows"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentTelemetryGroupRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentTelemetryGroupRow from a dict"""
        if obj is None:
            return None
