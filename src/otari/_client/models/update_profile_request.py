...
class UpdateProfileRequest(BaseModel):
    ...
    """ # noqa: E501
    full_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="The name to be known by on this deployment, or null to have none. Whitespace is collapsed, and a value with nothing else in it is stored as null, which leaves every surface naming this identity by its address again.")
