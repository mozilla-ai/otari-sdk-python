...
class DiscoverableModelsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DiscoverableModelsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DiscoverableModelsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "providers": [DiscoverableProvider.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
