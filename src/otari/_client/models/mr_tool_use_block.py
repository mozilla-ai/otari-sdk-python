...
class MRToolUseBlock(BaseModel):
    """
    MRToolUseBlock
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "caller", "input", "name", "type", "toolset_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MRToolUseBlock from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MRToolUseBlock from a dict"""
        if obj is None:
            return None
