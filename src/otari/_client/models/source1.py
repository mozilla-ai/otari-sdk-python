...
SOURCE1_ANY_OF_SCHEMAS = ["MRBase64PDFSource", "MRPlainTextSource"]
...
class Source1(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Source1 with anyOf schemas: MRBase64PDFSource, MRPlainTextSource. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Source1 with anyOf schemas: MRBase64PDFSource, MRPlainTextSource. Details: " + ", ".join(error_messages))
        else:
            return instance
