...
SYSTEM_ANY_OF_SCHEMAS = ["List[Dict[str, object]]", "str"]
...
class System(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = System.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in System with anyOf schemas: List[Dict[str, object]], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into System with anyOf schemas: List[Dict[str, object]], str. Details: " + ", ".join(error_messages))
        else:
            return instance
