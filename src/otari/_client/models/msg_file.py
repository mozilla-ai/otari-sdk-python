...
class MSGFile(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MSGFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MSGFile from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "file": MSGFileFile.from_dict(obj["file"]) if obj.get("file") is not None else None,
            "type": obj.get("type")
        })
        return _obj
