...
class MRAnyLlmTypesMessagesThinkingBlock(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MRAnyLlmTypesMessagesThinkingBlock from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MRAnyLlmTypesMessagesThinkingBlock from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "signature": obj.get("signature") if obj.get("signature") is not None else '',
