...
class OrgProviderModelsRefreshPublic(BaseModel):
    """
    ...
    repriced: List[StrictStr]
    __properties: ClassVar[List[str]] = ["added", "count", "discovery_unsupported", "error", "repriced"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrgProviderModelsRefreshPublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrgProviderModelsRefreshPublic from a dict"""
        if obj is None:
            return None
