...
class MSGChatCompletionContentPartImageParam(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MSGChatCompletionContentPartImageParam from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MSGChatCompletionContentPartImageParam from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "image_url": MSGImageURL.from_dict(obj["image_url"]) if obj.get("image_url") is not None else None,
            "type": obj.get("type")
        })
        return _obj
