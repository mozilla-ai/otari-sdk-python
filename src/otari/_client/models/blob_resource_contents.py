...
class BlobResourceContents(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_meta", "blob", "mimeType", "uri"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BlobResourceContents from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BlobResourceContents from a dict"""
        if obj is None:
            return None
