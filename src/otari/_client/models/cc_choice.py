...
class CCChoice(BaseModel):
    """
    CCChoice
    """ # noqa: E501
    finish_reason: StrictStr
    index: StrictInt
    logprobs: Optional[CCChoiceLogprobs] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CCChoice from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CCChoice from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "logprobs": CCChoiceLogprobs.from_dict(obj["logprobs"]) if obj.get("logprobs") is not None else None,
            "message": CCChatCompletionMessage.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
