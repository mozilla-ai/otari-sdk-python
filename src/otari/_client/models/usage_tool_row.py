...
class UsageToolRow(BaseModel):
    ...
    requests: StrictInt
    tool: StrictStr
    __properties: ClassVar[List[str]] = ["calls", "cost", "errors", "requests", "tool"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsageToolRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsageToolRow from a dict"""
        if obj is None:
            return None
