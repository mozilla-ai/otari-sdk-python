...
class AgentTelemetryGroupedSeriesPoint(BaseModel):
    ...
    rows: StrictInt
    __properties: ClassVar[List[str]] = ["bucket_start", "is_other", "key", "rows"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentTelemetryGroupedSeriesPoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentTelemetryGroupedSeriesPoint from a dict"""
        if obj is None:
            return None
