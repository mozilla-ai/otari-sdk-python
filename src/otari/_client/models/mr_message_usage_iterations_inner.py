...
class MRMessageUsageIterationsInner(BaseModel):
    ...
    # data type: MRBetaMessageIterationUsage
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = MRMessageUsageIterationsInner.model_construct()
        error_messages = []
        # validate data type: MRBetaMessageIterationUsage
        if not isinstance(v, MRBetaMessageIterationUsage):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MRBetaMessageIterationUsage`")
        else:
            return v

        # validate data type: MRBetaCompactionIterationUsage
        if not isinstance(v, MRBetaCompactionIterationUsage):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MRBetaCompactionIterationUsage`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[MRBetaMessageIterationUsage] = None
        try:
            instance.actual_instance = MRBetaMessageIterationUsage.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[MRBetaCompactionIterationUsage] = None
        try:
            instance.actual_instance = MRBetaCompactionIterationUsage.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
