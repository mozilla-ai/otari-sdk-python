...
class WorkspacePublic(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by_user_id", "description", "id", "name", "organization_id", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspacePublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspacePublic from a dict"""
        if obj is None:
            return None
