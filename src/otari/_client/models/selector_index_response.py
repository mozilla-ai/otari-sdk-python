...
class SelectorIndexResponse(BaseModel):
    ...
    short_selectors: StrictInt = Field(description="Offerings with an unambiguous short spelling.")
    __properties: ClassVar[List[str]] = ["models", "offerings", "short_selectors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "short_selectors": obj.get("short_selectors")
        })
        return _obj
