...
class MRBetaWebFetchToolResultErrorBlock(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['web_fetch_tool_result_error']):
            raise ValueError("must be one of enum values ('web_fetch_tool_result_error')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MRBetaWebFetchToolResultErrorBlock from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MRBetaWebFetchToolResultErrorBlock from a dict"""
        if obj is None:
            return None
