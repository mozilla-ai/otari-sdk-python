...
class CreateEmbeddingResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EMBEmbedding.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "model": obj.get("model"),
            "object": obj.get("object"),
            "usage": EMBUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
