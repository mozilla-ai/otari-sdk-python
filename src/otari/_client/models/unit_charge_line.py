...
class UnitChargeLine(BaseModel):
    ...
    meter: StrictStr = Field(description="What was metered, e.g. 'request' or 'web_search_calls'.")
    unit_rate: Union[StrictFloat, StrictInt] = Field(description="USD per call.")
    units: Units1
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["cost", "meter", "unit_rate", "units"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnitChargeLine from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnitChargeLine from a dict"""
        if obj is None:
            return None
