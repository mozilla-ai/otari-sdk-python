...
class ImagesResponse(BaseModel):
    ...
    data: Optional[List[IMGImage]] = None
    output_format: Optional[StrictStr] = None
    quality: Optional[StrictStr] = None
    size: Optional[StrictStr] = None
    usage: Optional[IMGUsage] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["created", "background", "data", "output_format", "quality", "size", "usage"]
    ...
    def background_validate_enum(cls, value):
        ...
        if value not in set(['transparent', 'opaque']):
    ...
    def output_format_validate_enum(cls, value):
        ...
        if value not in set(['png', 'webp', 'jpeg']):
            raise ValueError("must be one of enum values ('png', 'webp', 'jpeg')")
        return value
    ...
    def size_validate_enum(cls, value):
        ...
        if value not in set(['1024x1024', '1024x1536', '1536x1024']):
            raise ValueError("must be one of enum values ('1024x1024', '1024x1536', '1536x1024')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [IMGImage.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "output_format": obj.get("output_format"),
            "quality": obj.get("quality"),
            "size": obj.get("size"),
            "usage": IMGUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
