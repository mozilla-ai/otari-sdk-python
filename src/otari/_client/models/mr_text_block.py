...
class MRTextBlock(BaseModel):
    """
    MRTextBlock
    """ # noqa: E501
    citations: Optional[List[MRTextBlockCitationsInner]] = None
    text: StrictStr
    type: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MRTextBlock from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MRTextBlock from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "citations": [MRTextBlockCitationsInner.from_dict(_item) for _item in obj["citations"]] if obj.get("citations") is not None else None,
            "text": obj.get("text"),
            "type": obj.get("type")
        })
