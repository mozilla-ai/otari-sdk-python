...
class MSGChatCompletionMessageFunctionToolCallParam(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MSGChatCompletionMessageFunctionToolCallParam from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MSGChatCompletionMessageFunctionToolCallParam from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "function": MSGFunction.from_dict(obj["function"]) if obj.get("function") is not None else None,
            "type": obj.get("type")
        })
        return _obj
