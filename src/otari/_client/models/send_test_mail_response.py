...
class SendTestMailResponse(BaseModel):
    ...
    transport: StrictStr
    __properties: ClassVar[List[str]] = ["ok", "reason", "transport"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendTestMailResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendTestMailResponse from a dict"""
        if obj is None:
            return None
