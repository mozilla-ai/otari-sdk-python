...
class UsageSetPriceRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["api_key_id", "by_filter", "cache_read_price_per_million", "cache_write_price_per_million", "end_date", "endpoint", "ids", "input_price_per_million", "model", "output_price_per_million", "priced", "provider", "source", "source_label", "start_date", "status", "tool", "user_id", "workspace_id"]
