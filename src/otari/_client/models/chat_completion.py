...
class ChatCompletion(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    choices: List[CCChoice]
    created: StrictInt
    model: StrictStr
    object: StrictStr
    service_tier: Optional[StrictStr] = None
    system_fingerprint: Optional[StrictStr] = Field(default=None, description="Filter to a single event type or metric name (e.g. 'tool_result', 'claude_code.commit.count')")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if system_fingerprint (nullable) is None
        # and model_fields_set contains the field
        if self.system_fingerprint is None and "system_fingerprint" in self.model_fields_set:
            _dict['system_fingerprint'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "choices": [CCChoice.from_dict(_item) for _item in obj["choices"]] if obj.get("choices") is not None else None,
            "created": obj.get("created"),
            "model": obj.get("model"),
            "object": obj.get("object"),
            "service_tier": obj.get("service_tier"),
            "system_fingerprint": obj.get("system_fingerprint"),
            "usage": CCCompletionUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
