...
class PlaygroundFavoriteModelsUpdate(BaseModel):
    """
    ...
    """ # noqa: E501
    model_keys: Annotated[List[Annotated[str, Field(strict=True, max_length=512)]], Field(max_length=50)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaygroundFavoriteModelsUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaygroundFavoriteModelsUpdate from a dict"""
        if obj is None:
            return None
