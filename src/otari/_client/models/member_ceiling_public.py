...
class MemberCeilingPublic(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["budget_id", "id", "max_budget"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberCeilingPublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberCeilingPublic from a dict"""
        if obj is None:
            return None
