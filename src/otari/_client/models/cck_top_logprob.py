...
class CCKTopLogprob(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["token", "bytes", "logprob"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CCKTopLogprob from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CCKTopLogprob from a dict"""
        if obj is None:
            return None
