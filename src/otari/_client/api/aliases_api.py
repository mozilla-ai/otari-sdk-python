...
class AliasesApi:
    ...
    def delete_alias_v1_aliases_name_delete(
        self,
        name: StrictStr,
        user_id: Annotated[Optional[StrictStr], Field(description="Delete the alias scoped to this user. Omit to delete the global alias of that name.")] = None,
        ...
        :param name: (required)
        :type name: str
        :param user_id: Delete the alias scoped to this user. Omit to delete the global alias of that name.
        :type user_id: str
