...
class OrganizationUsageApi:
    ...
    def organization_usage_count_organization_usage(
        ...
        :type priced: bool
        :param tool: Filter to requests that ran a gateway-run tool. 'any' matches any tool; a tool name (web_search, web_fetch, code_execution) matches that tool specifically.
        :type tool: str
