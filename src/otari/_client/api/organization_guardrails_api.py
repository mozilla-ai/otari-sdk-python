...
class OrganizationGuardrailsApi:
    ...
    def _organization_guardrails_create_organization_guardrail_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/organizations/me/guardrails',
    ...
    def _organization_guardrails_delete_organization_guardrail_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/organizations/me/guardrails/{guardrail_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def organization_guardrails_test_organization_guardrail(
        self,
        guardrail_id: UUID,
        organization_guardrail_test: OrganizationGuardrailTest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param guardrail_id: (required)
        :type guardrail_id: UUID
        :param organization_guardrail_test: (required)
        :type organization_guardrail_test: OrganizationGuardrailTest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._organization_guardrails_test_organization_guardrail_serialize(
            guardrail_id=guardrail_id,
            organization_guardrail_test=organization_guardrail_test,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrganizationGuardrailTestResult",
            '422': "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def organization_guardrails_test_organization_guardrail_with_http_info(
        self,
        guardrail_id: UUID,
        organization_guardrail_test: OrganizationGuardrailTest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrganizationGuardrailTestResult]:
        """Test Organization Guardrail
    ...
    @validate_call
    def organization_guardrails_test_organization_guardrail_without_preload_content(
        self,
        guardrail_id: UUID,
        organization_guardrail_test: OrganizationGuardrailTest,
        _request_timeout: Union[
    ...
    def _organization_guardrails_test_organization_guardrail_serialize(
        self,
        guardrail_id,
        organization_guardrail_test,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if organization_guardrail_test is not None:
            _body_params = organization_guardrail_test
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/organizations/me/guardrails/{guardrail_id}/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
