...
class RoutingApi:
    ...
    def _delete_organization_routing_policy_api_v1_organizations_me_routing_policies_name_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/organizations/me/routing-policies/{name}',
    ...
    def _delete_policy_api_v1_routing_policies_name_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/routing/policies/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _explain_policy_api_v1_routing_policies_explain_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/routing/policies/explain',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_policies_api_v1_routing_policies_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/routing/policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_visible_routing_policies_api_v1_organizations_me_routing_policies_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/organizations/me/routing-policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _rank_candidates_api_v1_routing_preferences_rank_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/routing/preferences/rank',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _routing_memory_status_api_v1_routing_status_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/routing/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
