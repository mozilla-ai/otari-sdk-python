...
class InvitationsApi:
    ...
    @validate_call
    def accept_invitation_v1_invitations_accept_post(
        self,
        ...
        _param = self._accept_invitation_v1_invitations_accept_post_serialize(
    ...
    @validate_call
    def accept_invitation_v1_invitations_accept_post_with_http_info(
        self,
        accept_invitation_request: AcceptInvitationRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def accept_invitation_v1_invitations_accept_post_without_preload_content(
        self,
        accept_invitation_request: AcceptInvitationRequest,
        _request_timeout: Union[
            None,
    ...
    def _accept_invitation_v1_invitations_accept_post_serialize(
        self,
        ...
        if accept_invitation_request is not None:
            _body_params = accept_invitation_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/invitations/accept',
    ...
    @validate_call
    def validate_invitation_v1_invitations_validate_post(
        self,
        ...
        :param validate_invitation_request: (required)
        :type validate_invitation_request: ValidateInvitationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._validate_invitation_v1_invitations_validate_post_serialize(
    ...
    @validate_call
    def validate_invitation_v1_invitations_validate_post_with_http_info(
        self,
        validate_invitation_request: ValidateInvitationRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InvitationPreviewPublic]:
        """Validate Invitation
    ...
    @validate_call
    def validate_invitation_v1_invitations_validate_post_without_preload_content(
        self,
        validate_invitation_request: ValidateInvitationRequest,
        _request_timeout: Union[
            None,
    ...
    def _validate_invitation_v1_invitations_validate_post_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if validate_invitation_request is not None:
            _body_params = validate_invitation_request
