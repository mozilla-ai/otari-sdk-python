...
class FeedbackApi:
    ...
    def feedback_submit_feedback(
        ...
        _param = self._feedback_submit_feedback_serialize(
    ...
    @validate_call
    def feedback_submit_feedback_with_http_info(
        self,
        feedback_submission: FeedbackSubmission,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def feedback_submit_feedback_without_preload_content(
        self,
        feedback_submission: FeedbackSubmission,
        _request_timeout: Union[
            None,
    ...
    def _feedback_submit_feedback_serialize(
        self,
        feedback_submission,
        _request_auth,
        _content_type,
