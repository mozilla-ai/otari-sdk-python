...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "GatewayTokenAuth": APIKeyAuthSetting,
...
conf = otari._client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("otari._client")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'GatewayTokenAuth' in self.api_key:
